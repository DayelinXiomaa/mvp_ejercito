...
export const VideoPlayerModal: React.FC<VideoPlayerModalProps> = ({
  ...
  const colorMap = {
    ...
    cyan: {
      ...
      playBg: 'bg-cyan-500 hover:bg-cyan-400 text-slate-950',
      accentText: 'text-cyan-400',
      rangeAccent: 'accent-cyan-400',
    },
    amber: {
  ...
  // Detener video (Stop completo y volver al inicio a 0:00)
    ...
    >
        ...
        <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] text-slate-400 hidden sm:inline">• Ejército del Perú</span>
            </div>
      ...
      <div className="flex-1 min-h-0 flex items-center justify-center p-1 sm:p-2 my-1 sm:my-2 relative">
        ...
        >
          ...
          {/* Animación central al pausar o reproducir */}
          {showCenterIcon && (
